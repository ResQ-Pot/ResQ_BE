locals {
  common_project_name = "resqpot" # TODO: Change this to your project name
  common_project_id = "resqpot-490506" # TODO: Change this to your project id
  ...
  database_name = "resqpot" # TODO: Change this to your database name
}
